...
namespace MBur.Collections.LockFree_v1
{
    ...
    public class ConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue> where TKey : notnull
    {
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="key"/> is a null reference
        /// (Nothing in Visual Basic).</exception>
        public bool TryGetValue1(TKey key, out TValue value)
        {
            if (key == null)
            {
                ThrowKeyNullException();
        ...
        public bool TryGetValue(TKey key, out TValue value)
        {
            ...
            unchecked
            {
                ...
                ref var keys = ref frame.KeysTable[index];
                ...
                {
                    value = frame.ValuesTable[index].Value0;
                ...
                {
                    value = frame.ValuesTable[index].Value1;
                ...
                {
                    value = frame.ValuesTable[index].Value2;
                ...
                {
                    value = frame.ValuesTable[index].Value3;
        ...
        public bool TryGetValue_Orig(TKey key, out TValue value)
        {
            if (key == null)
            {
                ThrowKeyNullException();
